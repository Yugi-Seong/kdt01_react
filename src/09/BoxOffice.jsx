...
export default function BoxOffice() {
  ...
  const getFetchData = async () => {
    ...
    // url  = `${url}key=${apiKey}&target/Dt=${yesterday}` ;
    url = `${url}key=${apiKey}&targetDt=${date.replaceAll('-', '')}`;
  ...
  return (
    ...
    <div className="w-full relative overflow-x-auto m-10">
      <div className='w-full flex justify-end items-end'>
        날짜 기준 :
        <input type='date' className='border' id='date' ref={refDate} onChange={changeDate} />
      </div>
